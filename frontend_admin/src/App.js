...
import AllNurses from './pages/AllNurses';
            ...
            <Layout>
                <Content style={{ padding: "20px" }}>
                    <Routes>
                        ...
                        <Route path="/patients/records/:id" element={isAuthenticated ? <PatientRecords /> : <Navigate to="/login" />} />
                        <Route path="/patients/records" element={isAuthenticated ? <AllPatients /> : <Navigate to="/login" />} />
                        ...
                        <Route path="/nurses/records/:id" element={isAuthenticated ? <NurseRecords /> : <Navigate to="/login" />} />
                        <Route path="/nurses/records" element={isAuthenticated ? <AllNurses /> : <Navigate to="/login" />} />
